...
ConnectedWidget.defaultProps = {
  title: "الشات بوت الصحي 937",
  subtitle: "937 Healthcare Chatbot",
  customData: {},
  inputTextFieldHint: '... اكتب رسالة',
  connectingText: '... جاري الاتصال بالسيرفر',
  ...
  onSocketEvent: {},
  protocol: 'socketio',
  socketUrl: 'http://{website url}:5005',
  profileAvatar: 'rasa-webchat/assets/logo.png',
  protocolOptions: {},
  badge: 0,
  embedded: false,
  params: {
